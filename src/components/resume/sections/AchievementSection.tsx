      ...
      {items.map((item, index) => (
        <div key={item.id} className="rounded-xl border border-border bg-card p-4 space-y-3 relative">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              <Label className="text-xs font-medium">Achievement Title / Honor</Label>
              <Input
                value={item.title}
            ...
            <div>
              <Label className="text-xs font-medium">Date / Year (Optional)</Label>
              <Input
                value={item.date}
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Provide context or impact of this accomplishment..."
              rows={2}
